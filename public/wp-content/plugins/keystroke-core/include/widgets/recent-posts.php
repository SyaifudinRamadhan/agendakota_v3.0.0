 ...
 * @package keystroke
 */
if( !class_exists('keystroke_Recent_Post') ){
    class keystroke_Recent_Post extends WP_Widget{
        /**
        ...
        function __construct(){
            ...
            $widget_options = array(
                'description'                   => esc_html__('Keystroke: Recent post here', 'keystroke'),
                'customize_selective_refresh'   => true,
            );

            parent:: __construct('keystroke_Recent_Post', esc_html__( 'Keystroke: Recent Post', 'keystroke'), $widget_options );
        ...
        $title = ( ! empty( $instance['title'] ) ) ? $instance['title'] : esc_html__( 'Recent Posts','keystroke' );
               ...
               <div class="inner">
                    ...
                    while($posts->have_posts()) : $posts->the_post();  ?>
                        <div class="small-post">
                            ...
                            <?php endif ?>
                            <div class="content">
                                <h6><a href="<?php the_permalink(); ?>"><?php echo wp_trim_words( get_the_title(), $num_title_word,' '); ?></a></h6>
                                <?php
                                if($show_date && $show_read_time){ ?>
                                    <ul class="blog-meta">
                                        ...
                                        <?php if ($show_read_time):
                                            if (function_exists('keystroke_content_estimated_reading_time')){ ?>
    ...
    ?>
        <p><label for="<?php echo esc_attr($this->get_field_id( 'title' )); ?>"><?php echo esc_html__( 'Title:','keystroke' ); ?></label>
        <input class="widefat" id="<?php echo esc_attr($this->get_field_id( 'title' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'title' )); ?>" type="text" value="<?php echo esc_attr($title); ?>" /></p>
        
        
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'show_item' )); ?>"><?php echo esc_html__( 'No. of Item of posts to show:','keystroke' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'num_title_word' )); ?>"><?php echo esc_html__( 'Title Word','keystroke' ); ?></label>
        ...
        <p>
            ...
            <label for="<?php echo esc_attr($this->get_field_id( 'show_date' )); ?>"><?php echo esc_html__( 'Display post date?','keystroke' ); ?></label>
        </p>
        <p>
            ...
            <label for="<?php echo esc_attr($this->get_field_id( 'show_read_time' )); ?>"><?php echo esc_html__( 'Display Read Time?','keystroke' ); ?></label>
        </p>
    <?php
        }
    }
...
function keystroke_Recent_Post(){
    register_widget('keystroke_Recent_Post');
}
add_action('widgets_init','keystroke_Recent_Post');
