...
function websdkready() {
  ...
  var API_KEY = "5Ktt2Z3fQTyn0wSVVTKpXg";//Ini Diubah 1
   ...
   */
  var API_SECRET = "S4psQKnlyJWkXEzgP3H9fyEJ5ryft3tPCJlM"; //Ini diubah 2
  ...
  document
    ...
    .addEventListener("click", function (e) {
      ...
      if (!meetingConfig.mn || !meetingConfig.name) {
        ...
        Swal.fire({
            title: 'Error !!!',
            text: 'ID Meeting atau username kosong',
            icon: 'error',
      ...
      var signature = ZoomMtg.generateSignature({
        ...
        success: function (res) {
          ...
          var joinUrl = "/zoom/meeting.html?" + testTool.serialize(meetingConfig); //ini diubah 3
          console.log(joinUrl);
    ...
    var signature = ZoomMtg.generateSignature({
      ...
      success: function (res) {
        ...
        var joinUrl =
          ...
          "/zoom/meeting.html?" + //ini diubah 4
...
// var target2 = $('ReactModalPortal');
console.log('Ini target d-none');
console.log(target2);
