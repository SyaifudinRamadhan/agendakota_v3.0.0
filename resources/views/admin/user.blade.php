...
<h2>User</h2>
<p class="teks-transparan mb-4 d-inline">Ringkasan data user AgendaKota.id</p>
<button class="btn btn-sm bg-primer float-right d-inline font-inter" data-toggle="modal" data-target="#tambah_user"><i
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-center mx-auto">Tambah User Baru</h5>
            </div>
...
<div class="modal fade" id="edit_user" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body p-5">
                <form id="form_edit" action="{{ route('admin.user.update') }}" method="POST">
                    @csrf
                    <div class="form-group">
                        <label for="">Nama</label>
