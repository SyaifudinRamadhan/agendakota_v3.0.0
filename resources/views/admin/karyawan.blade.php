...
<h2>Admin</h2>
<p class="teks-transparan mb-4 d-inline">Ringkasan data Admin AgendaKota.id</p>
<button class="btn btn-sm bg-primer float-right d-inline font-inter" data-toggle="modal" data-target="#tambah_admin"><i
...
<!-- Modal -->
<div class="modal fade" id="tambah_admin" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
...
{{-- Modal Edit --}}
<div class="modal fade" id="edit_admin" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body p-5">
                <form id="form_edit" action="{{ route('admin.karyawan.update') }}" method="POST">
                    @csrf
                    <div class="form-group">
                        <label for="">Nama</label>
...
<script>
    $(document).on('click', ".edit", function() {        
        ...
        $.ajax({
            url: "{{ route('admin.karyawan.edit') }}?id=" + id,
            type: "GET",
            dataType: "JSON",
