...
<div class="container-cadangan">
    <div class="row">
        <div class="col-md-7">
            <h2 style="color: #304156;">New Exhibitor</h2>
        </div>
        <div class="col-md-5">
    ...
    <form action="{{route('organization.event.exhibitor.store',[$organizationID,$eventID])}}" method="POST" enctype="multipart/form-data">
        <div class="row">
        @csrf
            <div class="col-md-8">
                <div class="row">
                    <div class="col-lg-4">
                        <div class="wrap">
                            ...
                            <div id="inputLogoArea" class="bagi lebar-100 mt-1">
                                <input type="file" accept="image/jpg, image/png, image/jpeg" id="input-file" class="box no-bg" name="logo" onchange="uploadLogo(this, {{ json_encode($organization->user->package->max_attachment) }})" required oninvalid="this.setCustomValidity('Harap Upload Gambar')" oninput="setCustomValidity('')">
                                <label class="lebar-100" for="input-file">
                            ...
                            <div id="previewLogoArea" class="d-none bagi lebar-100">
                                <img id="logoPreview" class="rounded-5 asp-rt-1-1" width="100%" >
                                <br />
                    ...
                    <div class="col-lg-8">
                        ...
                        <input type="text"  class="box no-bg" name="name" value="{{old('name')}}" placeholder="Your Company Name">

                        <div class="mt-2 font-inter-header" style="padding-top: 3%; color: #304156;">Email Address :</div>
                        <input type="text"  class="box no-bg" name="email" value="{{old('email')}}" placeholder="youremail@company.com">
                    </div>
                </div>

                <div class="mt-4" style="padding-top: 3%; color: #304156;">Password :</div>
                    <input type="password" class="box no-bg" name="password" value="{{ old('password') }}">
                ...
                <input type="text"  class="box no-bg" name="address" value="{{old('address')}}" placeholder="Alamat Perusahaan Anda">

                <div class="mt-2 font-inter-header" style="padding-top: 3%; color: #304156;">Telp :</div>
                <input type="text" maxlength="13" class="box no-bg" name="phone" value="{{old('phone')}}" placeholder="No. Telp Perusahaan Anda">
                ...
                <div class="form-group font-inter-header">
                    ...
                    <div class="input-group mt-1">
                        ...
                        <input type="text" name="linkedin" id="linkedin"class="form-control" placeholder="https://www.Linkedin.com/yourprofile" aria-label="https://www.Linkedin.com/yourprofile" aria-describedby="https://www.Linkedin.com/yourprofile" aria-label="https://www.Linkedin.com/yourprofil" value="{{old('linkedin')}}">
                    </div>
                </div>
                ...
                <div class="font-inter virtual-booth" id="virtualbox" style="color: #304156;margin-top:25%;">
                    ...
                    <label class="label-checkbox font-inter" style="margin-top: 20px;">Enable Virtual Booth
                        <input type="checkbox" name="virtual_booth" value="1" id="enableVirtual"  {{ old('virtual_booth') == '' ? '' : 'checked' }}>
                ...
                <div class="row" style="margin-top:3%;">
                    <div class="col-12 font-inter-header">
                        ...
                        <div class="row">
                            <div class="col-9">
                                <input type="text" id="copy_inputan" class="box no-bg" name="booth_link" value="{{old('booth_link')}}" placeholder="Your Booth Link. Zoom Only">
                            </div>
                            <div class="col-3 no-pd-l">
                                <button type="button" id="copy" onclick="copy_text()" class="box bg-primer">Copy</button>
                            </div>
                        </div>
                    </div>
                ...
                <textarea rows="10" class="box no-bg" name="description" placeholder="Deskripsi singkat tentang perusahaan">{{old('description')}}</textarea>

                <div class="mt-2 font-inter-header" style="padding-top: 3%; color: #304156;"><b>Background Image :</b></div>
                <div class="mt-2 font-inter" style="color: #979797;">Audience will see this image while enter exhibition page</div>

                {{-- background image --}}
                <div id="inputBoothArea" class="bagi lebar-100 mt-1">
                    <input type="file" accept="image/jpg, image/png, image/jpeg" id="input-file-bg" class="box no-bg" name="booth_image" onchange="uploadFotoBooth(this, {{ json_encode($organization->user->package->max_attachment) }})" required oninvalid="this.setCustomValidity('Harap Upload Gambar')" oninput="setCustomValidity('')">
                    <label for="input-file-bg" class="lebar-100">
                ...
                <div id="previewBoothArea" class="bagi lebar-100 d-none">
                    <img id="boothPreview" class="rounded-5 asp-rt-8-3" width="100%"><br />
                    <span class="btn btn-no-pd lebar-100 mt-3 pointer bg-merah" onclick="removeBoothPreview()">hapus</span>
                </div>
                ...
                <!-- <input type="text"  class="box no-bg" name="video" value="{{old('video')}}" placeholder="Masukkan Link Video"> -->
                <div id="inputVideoArea" class="bagi lebar-100 mt-1">
                    <input type="url" id="input-file-video" class="box no-bg" name="video_0" oninput="uploadVideo(this)" required oninvalid="this.setCustomValidity('Harap Upload Video')" oninput="setCustomValidity('')" placeholder="URL video YouTube ex(https://www.youtube.com/watch?v=8RpCLKoa3_A atau https://www.youtube.com/embed/8RpCLKoa3_A)">

                    <input type="hidden" id="video_link_insert" name="video" value="">
                ...
                <div id="previewVideoArea" class="bagi lebar-100 mt-4 d-none">
                    <iframe id="videoPreview" class="rounded-5 asp-rt-8-3" width="100%" controls>
                    </iframe>
                    <br />
                    <span class="btn btn-no-pd lebar-100 mt-3 pointer bg-merah" onclick="removeVideoPreview()">hapus</span>
                </div>
               

                <br>
                <div class="form-check mt-2">
                    <label class="label-checkbox font-inter" style="margin-top: 20px;font-weight: normal !important; margin-left: -20px !important;">  Tampil Di Overview Event Detail
                        <input class="form-check-input" type="checkbox" value="1" id="overview" name="overview" {{ old('overview') == null ? "" : 'checked' }}>
                        <span class="checkmark font-inter"></span>
                    </label>
                </div>

                <div class="lebar-100 text-center mb-4">
...
<script>
    ...
    const uploadVideo = (input, isEdit = null) => {
        ...
        // let reader = URL.createObjectURL(file);
            ...
            if (isEdit == null) {
                ...
                let preview = select("#editExhibitor #videoPreview");
                // select("#editExhibitor #inputVideoArea").classList.add('d-none');
                select("#editExhibitor #previewVideoArea").classList.remove('d-none');
                // preview.setAttribute('src', reader);
                document.querySelector("iframe").src = 'https://www.youtube.com/embed/'+idVideo;
            }
    }
    ...
    const removeVideoPreview = (isEdit = null) => {
        if (isEdit == null) {
            ...
            // select("#editExhibitor input[type='file']").value = "";
            select("#editExhibitor #inputVideoArea").classList.remove('d-none');
            select("#editExhibitor #previewVideoArea").classList.add('d-none');
        }
    }
