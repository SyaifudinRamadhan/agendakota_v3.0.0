                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="o_btn-xs o_bg-primary o_br o_heading o_text-xs"
                                                            ...
                                                            <a class="o_text-white" href="https://agendakota.id/admin/finance-report/withdrawals"
                                                                style="text-decoration: none;outline: none;color: #ffffff;display: block;padding: 7px 16px;mso-text-raise: 3px;">Admin Agendakota</a>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                        ...
                        <tbody>
                            <tr>
                                <td class="o_bg-ultra_light o_px-md o_py-xl o_xs-py-md o_sans o_text-md o_text-light"
                                    ...
                                    <p style="margin-top: 0px;margin-bottom: 0px;">Seorang user melakukan pengajuan penarikan keuangan dengan detail sebagai berikut</p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                        ...
                        <tbody>
                            <tr>
                                <td class="o_bg-white o_px-md o_py o_sans o_text o_text-secondary" align="center"
                                    ...
                                    <p style="margin-top: 0px;margin-bottom: 0px;">Notifikasi.
                                        User atas nama {{ $username }} telah
                                        {{ $command }} permintaan penarikan dana
                                        sebagai berikut. Segera cek system admin
                                        ...
                                        <table class="table table-striped">
                                            <thead>
                                                <tr>
                                                    <th scope="col">
                                                        <p
                                                            style="margin-left: 20px; font-size: 14px; text-align: left;">
                                                            <span
