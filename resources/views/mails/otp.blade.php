                                                        ...
                                                        <tr>
                                                            <td
                                                                ...
                                                                <div style="line-height:10px"><img alt="Image"
                                                                        src="{{ $message->embed(public_path().'/images/mail-send-img/logo-ak2020.png') }}"
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td
                                                                ...
                                                                <div align="right">
                                                                    <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="#" style="height:42px;width:111px;v-text-anchor:middle;" arcsize="34%" stroke="false" fillcolor="#e3edfe"><w:anchorlock/><v:textbox inset="0px,0px,0px,0px"><center style="color:#052d3d; font-family:Tahoma, Verdana, sans-serif; font-size:14px"><![endif]--><a
                                                                        href="#"
                                                                        style="text-decoration:none;display:inline-block;color:#052d3d;background-color:#e3edfe;border-radius:14px;width:auto;border-top:1px solid #e3edfe;border-right:1px solid #e3edfe;border-bottom:1px solid #e3edfe;border-left:1px solid #e3edfe;padding-top:5px;padding-bottom:5px;font-family:Lato, Tahoma, Verdana, Segoe, sans-serif;text-align:center;mso-border-alt:none;word-break:keep-all;"
                                                                        target="_blank"><span
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <table align="center" border="0" cellpadding="0" cellspacing="0"
                                        class="row-content stack" role="presentation"
                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #f5f5f5; color: #000000; width: 650px;"
                                        width="650">
                                        <tbody>
                                            <tr>
                                                <td class="column column-1"
                                                        ...
                                                        <tr>
                                                            <td
                                                                ...
                                                                <div align="center" style="line-height:10px"><img
                                                                        ...
                                                                        src="{{ $message->embed(public_path().'/images/mail-send-img/Loginn.png') }}"
                                                            ...
                                                            <td
                                                                ...
                                                                <div style="font-family: sans-serif">
                                                                    <div class="txtTinyMce-wrapper"
                                                                        ...
                                                                        <p
                                                                            style="margin: 0; font-size: 14px; mso-line-height-alt: 75px;">
                                                                            <span style="font-size:50px;"><strong><span
                                                                                        style="font-size:50px;"><span
                                                                                            style="font-size:24px;">Hi, {{$user->name}}</span></span></strong></span>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                                    ...
                                                                    <div class="txtTinyMce-wrapper"
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <span
                                                                                ...
                                                                                You are requesting an OTP for {{ $otp->action }} to Agendakota. And here is your code
                                                                            </span>
                                                                        </p>
                                                                        <div style="font-size: 42px;font-weight: bold;text-align: center;margin-top: 20px;color: #fc7318;letter-spacing: 5px;">
                                                                            {{ $otp->code }}
                                                                        </div>
                                                                        <div style="font-size: 14px;color: #666;margin-top: 40px;">
                                                                            If you were not requested this action, please ignore this message. Or you could change your password in order to
                                                                            secure your account.
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <tr>
                                                                        <td style="padding:0 15px 0 0px;"><a
                                                                                ...
                                                                                target="_blank"><img alt="Facebook"
                                                                                    height="32"
                                                                                    src="{{ $message->embed(public_path().'/images/mail-send-img/facebook2x.png') }}"
                                                                        ...
                                                                        <td style="padding:0 15px 0 0px;"><a
                                                                                ...
                                                                                target="_blank"><img alt="Twitter"
                                                                                    height="32"
                                                                                    src="{{ $message->embed(public_path().'/images/mail-send-img/twitter2x.png') }}"
                                                                                    style="display: block; height: auto; border: 0;"
                                                                        ...
                                                                        <td style="padding:0 15px 0 0px;"><a
                                                                                ...
                                                                                target="_blank"><img alt="Instagram"
                                                                                    height="32"
                                                                                    src="{{ $message->embed(public_path().'/images/mail-send-img/instagram2x.png') }}"
                                                                                    style="display: block; height: auto; border: 0;"
                                                                        ...
                                                                        <td style="padding:0 15px 0 0px;"><a
                                                                                ...
                                                                                target="_blank"><img alt="YouTube"
                                                                                    height="32"
                                                                                    src="{{ $message->embed(public_path().'/images/mail-send-img/youtube2x.png') }}"
                                                                                    style="display: block; height: auto; border: 0;"
                                                                ...
                                                                <div style="font-family: sans-serif">
                                                                    <div class="txtTinyMce-wrapper"
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            Koridor Co-Working Space, Siola Building 3rd
                                                                            Floor</p>
                                                                        <p
                                                                            style="margin: 0; font-size: 14px; text-align: center;">
                                                                                    ...
                                                                                    <td
                                                                                        ...
                                                                                        <a href="https://www.designedwithbee.com/"
                                                                                            ...
                                                                                            target="_blank"><img
                                                                                                ...
                                                                                                class="icon"
                                                                                                height="32"
                                                                                                src="{{ $message->embed(public_path().'/images/mail-send-img/bee.png') }}"
