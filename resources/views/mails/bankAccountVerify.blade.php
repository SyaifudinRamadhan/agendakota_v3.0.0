...
<head>
    ...
    <title>Bank Account Verify</title>
    <style type="text/css">
        a {
                        ...
                        <tbody>
                            <tr>
                                <td class="o_re o_bg-dark o_px o_pb-md o_br-t" align="center"
                                    style="font-size: 0;vertical-align: top;background-color: #e5214f; /*#eb597b*/border-radius: 4px 4px 0px 0px;padding-left: 16px;padding-right: 16px;padding-bottom: 24px;">
                                    ...
                                    <div class="o_col o_col-2"
                                        ...
                                        <div class="o_px-xs o_sans o_text o_left o_xs-center"
                                            style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;text-align: left;padding-left: 8px;padding-right: 8px; background-color: white;
                                            padding: 5px;
                                            text-align: center;
                                            border-radius: 6px;">
                                            <p style="margin-top: 0px;margin-bottom: 0px;"><a class="o_text-white"
                                                    style="text-decoration: none;outline: none;color: #ffffff;"><img
                                                        src="{{ $message->embed(public_path().'/images/mail-send-img/logo-ak2020.png') }}" width="136" height="36"
                                                        alt="Agendakota.id"
                                    ...
                                    <div class="o_col o_col-4"
                                        ...
                                        <div class="o_px-xs" style="padding-left: 8px;padding-right: 8px;">
                                            <table class="o_right o_xs-center" cellspacing="0" cellpadding="0"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="o_btn-xs o_bg-primary o_br o_heading o_text-xs"
                                                            align="center"
                        ...
                        <tbody>
                            <tr>
                                <td class="o_bg-ultra_light o_px-md o_py-xl o_xs-py-md o_sans o_text-md o_text-light"
                                    align="center"
                                    style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 19px;line-height: 28px;background-color: #ffedf1;color: #82899a;padding-left: 24px;padding-right: 24px;padding-top: 64px;padding-bottom: 64px;">
                                    <h1 class="o_heading o_text-dark o_mb-xxs"
                                        ...
                                        Informasi Layanan</h1>
                                    <p style="margin-top: 0px;margin-bottom: 0px;">Kamu telah menambahkan akun bank baru ke dalam akun organizermu.</p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                        ...
                        <tbody>
                            <tr>
                                <td class="o_bg-white o_px-md o_py o_sans o_text o_text-secondary" align="center"
                                    ...
                                    <p style="margin-top: 0px;margin-bottom: 0px;">Akun
                                        kamu terdeteksi melakukan aktivitas
                                        menambahkan no rekening baru untuk
                                        kepentingan penarikan penghasilan.
                                        Dengan no Rekening sebagai berikut.
                                        Silahkan klik <b>VERIFIKASI</b> jika itu memang
                                        kamu. Dan klik <B>BATALKAN</B> jika itu bukan
                                        kamu.</p>
                                    <p style="margin-top: 25px;margin-bottom: 0px;">No.
                                        Rekening : {{ $account }}</p>
                                    <p style="margin-top: 25px;margin-bottom: 0px;">Nama
                                        Bank : {{ $bank }}</p>
                                </td>
                            </tr>
                        </tbody>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td width="300" class="o_btn o_bg-success o_br o_heading o_text"
                                                    ...
                                                    <a class="o_text-white" href="{{ $links[0] }}"
                                                        style="text-decoration: none;outline: none;color: #ffffff;display: block;padding: 12px 24px;mso-text-raise: 3px;">Verifkasi</a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                            ...
                            <tr>
                                <td class="o_bg-white o_px-md o_py-xs" align="center"
                                    ...
                                    <table align="center" cellspacing="0" cellpadding="0" border="0"
                                        ...
                                        <tbody>
                                            <tr>
                                                <td width="300" class="o_btn o_bg-danger o_br o_heading o_text"
                                                    align="center"
                                                    style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;mso-padding-alt: 12px 24px;background-color: #c00e0e;border-radius: 4px;">
                                                    <a class="o_text-white" href="{{ $links[1] }}"
                                                        style="text-decoration: none;outline: none;color: #ffffff;display: block;padding: 12px 24px;mso-text-raise: 3px;">Batalkan</a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                    ...
                    <table class="o_block" width="100%" cellspacing="0" cellpadding="0" border="0"
                        ...
                        <tbody>
                            <tr>
                                <td class="o_bg-white o_px-md o_py o_sans o_text o_text-secondary" align="center"
                                    style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;background-color: #ffffff;color: #424651;padding-left: 24px;padding-right: 24px;padding-top: 16px;padding-bottom: 16px;">
                                    <p style="margin-top: 0px;margin-bottom: 0px;">Callously piranha however moronic
                                        selfless more because spitefully dear some far forward where mounted underneath
                                        however feeling out less alas.</p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                        ...
                        <tbody>
                            <tr>
                                <td class="o_re o_bg-dark o_px o_pb-lg o_br-b" align="center"
                                    style="font-size: 0;vertical-align: top;background-color: #e5214f; /*#eb597b*/border-radius: 0px 0px 4px 4px;padding-left: 16px;padding-right: 16px;padding-bottom: 32px;">
                                    <!--[if mso]><table cellspacing="0" cellpadding="0" border="0" role="presentation"><tbody><tr><td width="200" align="left" valign="top" style="padding:0px 8px;"><![endif]-->
                                    <div class="o_col o_col-4"
                                        style="display: inline-block;vertical-align: top;width: 100%;max-width: 400px;">
                                        ...
                                        <div class="o_px-xs o_sans o_text-xs o_text-dark_light o_left o_xs-center"
                                            ...
                                            <p style="margin-top: 0px;margin-bottom: 0px;">
                                                <a class="o_text-dark_light o_underline" href="https://agendakota.id/"
                                                    ...
                                                    Center</a> <span class="o_hide-xs">&nbsp; • &nbsp;</span><br
                                                    class="o_hide-lg"
                                                    style="display: none;font-size: 0;max-height: 0;width: 0;line-height: 0;overflow: hidden;mso-hide: all;visibility: hidden;">
                                                {{-- <a class="o_text-dark_light o_underline" href="https://example.com/"
                                                    style="text-decoration: underline;outline: none;color: #a0a3ab;">Preferences</a>
                                                <span class="o_hide-xs">&nbsp; • &nbsp;</span><br class="o_hide-lg"
                                                    style="display: none;font-size: 0;max-height: 0;width: 0;line-height: 0;overflow: hidden;mso-hide: all;visibility: hidden;">
                                                <a class="o_text-dark_light o_underline" href="https://example.com/"
                                                    style="text-decoration: underline;outline: none;color: #a0a3ab;">Unsubscribe</a> --}}
                                            </p>
                                        </div>
                                    </div>
                                    <!--[if mso]></td><td width="400" align="right" valign="top" style="padding:0px 8px;"><![endif]-->
                                    <div class="o_col o_col-2"
                                        ...
                                        <div class="o_px-xs o_sans o_text-xs o_text-dark_light o_right o_xs-center"
                                            ...
                                            {{-- <p style="margin-top: 0px;margin-bottom: 0px;">
                                                <a class="o_text-dark_light" href="https://example.com/"
                                                    style="text-decoration: none;outline: none;color: #a0a3ab;"><img
                                                        src="images/facebook-light.png" width="36" height="36"
                                                        alt="fb"
                                                ...
                                                <a class="o_text-dark_light" href="https://example.com/"
                                                    style="text-decoration: none;outline: none;color: #a0a3ab;"><img
                                                        src="images/twitter-light.png" width="36" height="36"
                                                        alt="tw"
                                                        style="max-width: 36px;-ms-interpolation-mode: bicubic;vertical-align: middle;border: 0;line-height: 100%;height: auto;outline: none;text-decoration: none;"></a><span>
                                                    &nbsp;</span>
                                                <a class="o_text-dark_light" href="https://example.com/"
                                                    style="text-decoration: none;outline: none;color: #a0a3ab;"><img
                                                        src="images/instagram-light.png" width="36"
                                                        height="36" alt="ig"
                                                        style="max-width: 36px;-ms-interpolation-mode: bicubic;vertical-align: middle;border: 0;line-height: 100%;height: auto;outline: none;text-decoration: none;"></a><span>
                                                    &nbsp;</span>
                                                <a class="o_text-dark_light" href="https://example.com/"
                                                    style="text-decoration: none;outline: none;color: #a0a3ab;"><img
                                                        src="images/snapchat-light.png" width="36" height="36"
                                                        alt="sc"
