                                                        ...
                                                        <td class="o_btn-b o_heading o_text-xs" align="center"
                                                            ...
                                                            <a class="o_text-light"
                                                                style="text-decoration: none;outline: none;color: #82899a;display: block;padding: 7px 8px;font-weight: bold;"><span
                                                                    style="mso-text-raise: 6px;display: inline;color: #82899a;">{{$email}}</span> <img
                                                                    src="{{ $message->embed(public_path().'/images/mail-send-img/person-24-light.png') }}" width="24"
                                                                    height="24" alt=""
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="o_bb-primary" height="40" width="32"
                                                    style="border-bottom: 1px solid #e5214f; /*#eb597b*/">&nbsp; </td>
                                                <td rowspan="2" class="o_sans o_text o_text-secondary o_px o_py"
                                                    ...
                                                    <img src="{{ $message->embed(public_path().'/images/mail-send-img/vpn_key-48-primary.png') }}" width="48"
                                                        height="48" alt=""
                            ...
                            <tr>
                                <td class="o_bg-white o_px-md o_py-xs" align="center"
                                    ...
                                    <table align="center" cellspacing="0" cellpadding="0" border="0"
                                        ...
                                        <tbody>
                                            <tr>
                                                <td width="300" class="o_btn o_bg-primary o_br o_heading o_text"
                                                    align="center"
                                                    ...
                                                    <a class="o_text-white" href="{{ $link, $email }}"
            ...
            <tr>
                <td class="o_bg-light o_px-xs o_pb-lg o_xs-pb-xs" align="center"
                    ...
                    <table class="o_block" width="100%" cellspacing="0" cellpadding="0" border="0"
                        ...
                        <tbody>
                            <tr>
                                <td class="o_re o_bg-white o_px o_pb-lg o_bt-light o_br-b" align="center"
                                    style="font-size: 0;vertical-align: top;background-color: #ffffff;border-top: 1px solid #d3dce0;border-radius: 0px 0px 4px 4px;padding-left: 16px;padding-right: 16px;padding-bottom: 32px;">
                                    <!--[if mso]><table cellspacing="0" cellpadding="0" border="0" role="presentation"><tbody><tr><td width="200" align="left" valign="top" style="padding:0px 8px;"><![endif]-->
                                    <div class="o_col o_col-4"
                                        style="display: inline-block;vertical-align: top;width: 100%;max-width: 400px;">
                                        ...
                                        <div class="o_px-xs o_sans o_text-xs o_text-light o_left o_xs-center"
                                            ...
                                            <p style="margin-top: 0px;margin-bottom: 0px;">
                                                ...
                                                {{-- <a class="o_text-light o_underline" href="https://example.com/"
                                                    style="text-decoration: underline;outline: none;color: #82899a;">Preferences</a>
                                                <span class="o_hide-xs">&nbsp; • &nbsp;</span><br class="o_hide-lg"
                                                    style="display: none;font-size: 0;max-height: 0;width: 0;line-height: 0;overflow: hidden;mso-hide: all;visibility: hidden;">
                                                <a class="o_text-light o_underline" href="https://example.com/"
                                                    style="text-decoration: underline;outline: none;color: #82899a;">Unsubscribe</a> --}}
                                            </p>
                                        </div>
                                    </div>
                                    <!--[if mso]></td><td width="400" align="right" valign="top" style="padding:0px 8px;"><![endif]-->
