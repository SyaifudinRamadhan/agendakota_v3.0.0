          ...
          >
            ...
            >
              <tbody>
                <tr>
                  <td
                    class="o_re o_bg-white o_px o_pb-md o_br-t"
                    align="center"
                    style="
                      font-size: 0;
                      vertical-align: top;
                      ...
                      >
                        ...
                        >
                          <tbody>
                            <tr>
                              <td
                                class="o_btn-xs o_bg-primary o_br o_heading o_text-xs"
                                align="center"
                                style="
                                  font-family: Helvetica, Arial, sans-serif;
                                  font-weight: bold;
                      ...
                      <tbody>
                        <tr>
                          <td
                            ...
                            height="40"
                            width="32"
                            style="border-bottom: 1px solid #eb597b"
                          >
                            &nbsp;
                          </td>
                          <td
                          ...
                          >
                            <img
                              src="{{ $message->embed(public_path().'/images/mail-send-img/record_voice_over-48-primary.png') }}"
                              width="48"
                              height="48"
                              alt=""
                              style="
                    ...
                    <p style="margin-top: 0px; margin-bottom: 0px">
                        @if (isset($receiver))
                            @if (isset($ticket_id))
                                <p
                                    ...
                                    <span
                                        style="font-size:18px;color:#000000;">Halo
                                        {{ $receiver }}. Kamu telah
                                        dibelikan tiket oleh temanmu. Di
                                        Website Agendakota.id dalam
                                        sebuah event
                                        {{ $event }}. Silahkan
                            ...
                            @else
                                <p
                                    ...
                                    <span
                                        style="font-size:18px;color:#000000;">Halo
                                        {{ $receiver }}. Kamu telah
                                        diundang oleh temanmu. Di
                                        Website Agendakota.id dalam
                                        sebuah event. Silahkan
                                        klik Lanjutkan untuk
                                        melanjutkan.</span>
                                </p>
                            @endif
                            ...
                            @if (isset($participant))
                                <p
                                    ...
                                    <span
                                        style="font-size:18px;color:#000000;">Halo
                                        {{ $email }}. Kamu telah
                                        diundang bergabung oleh temanmu.
                                        Di Website Agendakota.id dalam
                                        sebuah event
                                        {{ $event }}, sebagai
                                        {{ $participant }}. Silahkan
                                        klik Lanjutkan untuk
                                        melanjutkan.</span>
                                </p>
                            @else
                        ...
                        @if (isset($participant))
                            <p
                                style="margin: 0; font-size: 14px; text-align: center;">
                                <span style="font-size:18px;color:#000000;">
                                    Gunakan username dan password berikut
                                    untuk
                                    login. (Catatan : password, bisa diubah
                                    sendiri
                                    nanti sesuai
                                    keinginan user)
                                </span>
                            ...
                            <p
                                style="margin: 0; font-size: 14px; text-align: center;">
                                <span style="font-size:18px;color:#000000;">
                                    Password bisa kammu abaikan, jika kamu sudah
                                    mempunyai akun di sini sebelumnya (dengan
                                    email
                                    yang sama).
                                    Gunakan password yang sudah kamu atur
                                    sebelumnya.
                                </span>
                            </p>
                        ...
                        {{-- @else
                            <div align="center" style="margin-top: 15px">
                                <a
                                    ...
                                    target="_blank"><span
                                        style="padding-left:40px;padding-right:40px;font-size:16px;display:inline-block;letter-spacing:normal;"><span
                                            style="font-size: 16px; line-height: 2; word-break: break-word; mso-line-height-alt: 32px;"><strong>LANJUTKAN</strong></span></span></a>
          ...
          >
            ...
            >
              <tbody>
                <tr>
                  <td
                    class="o_re o_bg-white o_px o_pb-lg o_bt-light o_br-b"
                    align="center"
                    style="
                      font-size: 0;
                      vertical-align: top;
                  ...
                  >
                    ...
                    >
                      <div
                        style="font-size: 32px; line-height: 32px; height: 32px"
                      >
                        &nbsp;
                      </div>
                      <div
                        class="o_px-xs o_sans o_text-xs o_text-light o_left o_xs-center"
                        style="
                          font-family: Helvetica, Arial, sans-serif;
                          margin-top: 0px;
                          margin-bottom: 0px;
                      ...
                      >
                        ...
                        >
                          ©2022 Agendakota. All rights reserved.
                        </p>
                        <p
                          class="o_mb-xs"
                          style="margin-top: 0px; margin-bottom: 8px"
                        >
                        Koridor Co-Working Space, Siola 3rd Floor, Jl. Tunjungan No. 1, Surabaya
                        </p>
                        <p style="margin-top: 0px; margin-bottom: 0px">
                          <a
                    ...
                    >
                      ...
                      <div
                        class="o_px-xs o_sans o_text-xs o_text-light o_right o_xs-center"
                        style="
                          font-family: Helvetica, Arial, sans-serif;
                          margin-top: 0px;
                          margin-bottom: 0px;
